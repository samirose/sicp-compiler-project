(module
  ...
  (func (;30;)
    ...
    drop)
  (table (;0;) 16 funcref)
  (export "sequence-has-last-value" (func 24))
  (export "sequence-has-last-expressions-value" (func 25))
  (export "all-sequence-expressions-are-evaluated" (func 27))
  (export "sequence-expressions-are-evaluated-in-order" (func 29))
  (start 30)
  (elem (;0;) (i32.const 0) func 9 10 11 12 13 14 15 16 19 23 24 25 26 27 28 29)
