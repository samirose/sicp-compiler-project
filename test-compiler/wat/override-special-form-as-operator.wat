(module
  ...
  (export "override-quote-arg" (func 21))
  (export "override-define-let" (func 23))
  (export "override-define-arg" (func 26))
  (export "override-lambda-let" (func 28))
  (export "override-lambda-arg" (func 31))
  (export "override-special-symbols-let*" (func 34))
  (start 35)
