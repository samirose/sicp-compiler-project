...
HOST_SCHEME_COMPILE_MODULE = GUILE_LOAD_COMPILED_PATH="$(HOST_SCHEME_COMPILED_DIR_REALPATH)" guild compile $(HOST_SCHEME_FLAGS)
HOST_SCHEME_RUN_PROGRAM = guile $(HOST_SCHEME_FLAGS) \
  -C "$(HOST_SCHEME_COMPILED_DIR_REALPATH)" \
  --no-auto-compile
