(module
  ...
  (func (;26;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "single-exp" (func 14))
  (export "single-exp-else" (func 15))
  (export "test-and-exp" (func 16))
  (export "test-and-exp-else" (func 17))
  (export "only-else" (func 18))
  (export "nested" (func 19))
  (export "short-circuit" (func 20))
  (export "sequence-exps" (func 21))
  (export "lambda-exps" (func 25))
  (start 26)
