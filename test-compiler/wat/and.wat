(module
  ...
  (func (;20;)
    ...
    drop)
  (table (;0;) 14 funcref)
  (export "empty-and-is-true" (func 11))
  (export "and-one-false-is-false" (func 12))
  (export "and-one-non-false-value-is-value" (func 13))
  (export "and-two-non-false-values-is-last-value" (func 14))
  (export "and-any-false-is-false" (func 15))
  (export "and-with-complex-expressions" (func 17))
  (export "and-evaluates-expressions-from-left-to-right" (func 18))
  (export "and-false-short-circuits-to-false" (func 19))
  (start 20)
