(module
  ...
  (func (;28;)
    ...
    drop)
  (table (;0;) 20 funcref)
  (export "single-exp" (func 16))
  (export "single-exp-else" (func 17))
  (export "test-and-exp" (func 18))
  (export "test-and-exp-else" (func 19))
  (export "only-else" (func 20))
  (export "nested" (func 21))
  (export "short-circuit" (func 22))
  (export "sequence-exps" (func 23))
  (export "lambda-exps" (func 27))
  (start 28)
