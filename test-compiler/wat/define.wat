(module
  ...
  (func (;32;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "define-constants" (func 24))
  (export "define-combinations" (func 25))
  (export "define-lambda-combination" (func 27))
  (export "define-procedure" (func 29))
  (export "define-procedure-with-lambda" (func 31))
  (start 32)
