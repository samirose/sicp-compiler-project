(module
  ...
  (func (;32;)
    ...
    drop)
  (table (;0;) 24 funcref)
  (export "override-quote-let" (func 15))
  (export "override-quote-arg" (func 18))
  (export "override-define-let" (func 20))
  (export "override-define-arg" (func 23))
  (export "override-lambda-let" (func 25))
  (export "override-lambda-arg" (func 28))
  (export "override-special-symbols-let*" (func 31))
  (start 32)
