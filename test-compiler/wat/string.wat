(module
  ...
  (func (;31;)
    ...
    drop)
  (table (;0;) 23 funcref)
  (export "literal-string-is-string" (func 18))
  (export "literal-strings-as-values-are-strings" (func 21))
  (export "string-may-contain-special-characters" (func 22))
  (export "string=?-empty-literal-strings" (func 23))
  (export "string=?-one-char-equal-strings" (func 24))
  (export "string=?-one-char-nonequal-strings" (func 25))
  (export "string=?-literal-strings-with-equal-content" (func 26))
  (export "string=?-literal-strings-with-same-length-nonequal-content" (func 27))
  (export "string=?-literal-strings-with-different-length" (func 28))
  (export "string=?-expects-string-first-argument" (func 29))
  (export "string=?-expects-string-second-argument" (func 30))
  (start 31)
