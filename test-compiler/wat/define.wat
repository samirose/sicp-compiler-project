(module
  ...
  (func (;22;)
    ...
    drop)
  (table (;0;) 14 funcref)
  (export "define-constants" (func 14))
  (export "define-combinations" (func 15))
  (export "define-lambda-combination" (func 17))
  (export "define-procedure" (func 19))
  (export "define-procedure-with-lambda" (func 21))
  (start 22)
