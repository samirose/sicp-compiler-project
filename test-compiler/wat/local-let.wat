(module
  ...
  (func (;32;)
    ...
    drop)
  (table (;0;) 24 funcref)
  (export "constant-let" (func 15))
  (export "expression-let" (func 16))
  (export "multi-variable-let" (func 17))
  (export "nested-let" (func 18))
  (export "nested-let-referring-outer-let" (func 19))
  (export "let-shadowing-let" (func 20))
  (export "let-in-lambda" (func 22))
  (export "let-value-referring-lambda-arg" (func 24))
  (export "let-value-shadowing-lambda-arg" (func 26))
  (export "lambda-as-let-value" (func 28))
  (export "mutate-locals" (func 29))
  (export "get-global-with-let-value" (func 30))
  (export "get-global-assigned-with-let-value" (func 31))
  (start 32)
