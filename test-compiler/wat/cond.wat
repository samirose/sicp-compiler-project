(module
  ...
  (func (;30;)
    ...
    drop)
  (table (;0;) 22 funcref)
  (export "single-exp" (func 18))
  (export "single-exp-else" (func 19))
  (export "test-and-exp" (func 20))
  (export "test-and-exp-else" (func 21))
  (export "only-else" (func 22))
  (export "nested" (func 23))
  (export "short-circuit" (func 24))
  (export "sequence-exps" (func 25))
  (export "lambda-exps" (func 29))
  (start 30)
