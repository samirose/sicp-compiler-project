(module
  ...
  (func (;31;)
    ...
    drop)
  (table (;0;) 23 funcref)
  (export "lambda-application" (func 16))
  (export "lambda-argument" (func 20))
  (export "lambda-without-parameters" (func 22))
  (export "lambda-parameters-shadow-globals" (func 24))
  (export "inner-lambda-parameters-shadow-outer" (func 27))
  (export "lambda-procedure-result" (func 30))
  (start 31)
