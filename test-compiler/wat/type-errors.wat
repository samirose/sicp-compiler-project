(module
  ...
  (func (;24;)
    ...
    drop)
  (table (;0;) 16 funcref)
  (export "plus-two" (func 15))
  (export "two-times" (func 16))
  (export "lambda-two-times" (func 18))
  (export "procedure-plus-two" (func 19))
  (export "apply-to" (func 20))
  (export "unspecified-plus-two" (func 21))
  (export "unspecified-as-operator" (func 23))
  (start 24)
