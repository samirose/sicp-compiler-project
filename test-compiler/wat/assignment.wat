(module
  ...
  (func (;26;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "set!-local-lambda" (func 19))
  (export "set!-local-let" (func 20))
  (export "set!-global" (func 21))
  (export "get-global" (func 22))
  (export "increment-global!" (func 23))
  (export "get-lambda-computed-global" (func 24))
  (start 26)
