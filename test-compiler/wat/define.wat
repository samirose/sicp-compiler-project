(module
  ...
  (func (;26;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "define-constants" (func 18))
  (export "define-combinations" (func 19))
  (export "define-lambda-combination" (func 21))
  (export "define-procedure" (func 23))
  (export "define-procedure-with-lambda" (func 25))
  (start 26)
