(module
  ...
  (func (;32;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "set!-local-lambda" (func 25))
  (export "set!-local-let" (func 26))
  (export "set!-global" (func 27))
  (export "get-global" (func 28))
  (export "increment-global!" (func 29))
  (export "get-lambda-computed-global" (func 30))
  (start 32)
