(module
  ...
  (export "let*-shadowing" (func 17))
  (export "let*-in-lambda" (func 19))
  (export "let*-value-referring-lambda-arg" (func 21))
  (export "let*-value-shadowing-lambda-arg" (func 23))
  (export "lambda-as-let*-value" (func 25))
  (export "mutate-locals" (func 26))
  (export "get-global-with-let*-value" (func 27))
  (export "get-global-assigned-with-let*-value" (func 28))
  (start 29)
