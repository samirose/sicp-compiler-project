(module
  ...
  (func (;33;)
    ...
    drop)
  (table (;0;) 25 funcref)
  (export "lambda-application" (func 18))
  (export "lambda-argument" (func 22))
  (export "lambda-without-parameters" (func 24))
  (export "lambda-parameters-shadow-globals" (func 26))
  (export "inner-lambda-parameters-shadow-outer" (func 29))
  (export "lambda-procedure-result" (func 32))
  (start 33)
