(module
  ...
  (func (;24;)
    ...
    drop)
  (table (;0;) 16 funcref)
  (export "sequence-has-last-value" (func 18))
  (export "sequence-has-last-expressions-value" (func 19))
  (export "all-sequence-expressions-are-evaluated" (func 21))
  (export "sequence-expressions-are-evaluated-in-order" (func 23))
  (start 24)
