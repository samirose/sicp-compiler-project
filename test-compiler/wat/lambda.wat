(module
  ...
  (func (;32;)
    ...
    drop)
  (table (;0;) 24 funcref)
  (export "lambda-application" (func 17))
  (export "lambda-argument" (func 21))
  (export "lambda-without-parameters" (func 23))
  (export "lambda-parameters-shadow-globals" (func 25))
  (export "inner-lambda-parameters-shadow-outer" (func 28))
  (export "lambda-procedure-result" (func 31))
  (start 32)
