(module
  ...
  (export "quoted-number" (func 25))
  (export "quoted-number-is-number?" (func 26))
  (export "boolean-true" (func 27))
  (export "boolean-false" (func 28))
  (export "quoted-boolean-true" (func 29))
  (export "quoted-boolean-false" (func 30))
  (export "quoted-boolean-is-boolean?" (func 31))
  (start 32)
