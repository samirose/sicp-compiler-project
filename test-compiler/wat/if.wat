(module
  ...
  (func (;31;)
    ...
    drop)
  (table (;0;) 23 funcref)
  (export "if-true" (func 14))
  (export "if-true-expression" (func 15))
  (export "if-true-does-not-evaluate-alternative" (func 16))
  (export "if-true-consequent-only" (func 17))
  (export "if-false" (func 18))
  (export "if-false-expression" (func 19))
  (export "if-false-does-not-evaluate-consequent" (func 20))
  (export "if-false-consequent-only" (func 21))
  (export "if-lambda-condition" (func 23))
  (export "if-lambda-consequent" (func 26))
  (export "if-lambda-alternative" (func 30))
  (start 31)
