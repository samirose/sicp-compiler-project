(module
  ...
  (func (;31;)
    ...
    drop)
  (table (;0;) 17 funcref)
  (export "not-true-is-false" (func 24))
  (export "not-false-is-true" (func 25))
  (export "not-non-false-value-is-false" (func 26))
  (export "not-true-expression-is-false" (func 27))
  (export "not-non-false-expression-is-false" (func 29))
