(module
  ...
  (func (;26;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "number" (func 18))
  (export "quoted-number" (func 19))
  (export "quoted-number-is-number?" (func 20))
  (export "boolean-true" (func 21))
  (export "boolean-false" (func 22))
  (export "quoted-boolean-true" (func 23))
  (export "quoted-boolean-false" (func 24))
  (export "quoted-boolean-is-boolean?" (func 25))
  (start 26)
