(module
  ...
  (func (;33;)
    ...
    drop)
  (table (;0;) 19 funcref)
  (export "empty-or-is-false" (func 24))
  (export "or-one-false-is-false" (func 25))
  (export "or-one-non-false-value-is-value" (func 26))
  (export "or-two-non-falses-is-first-value" (func 27))
  (export "or-any-non-false-is-non-false" (func 28))
  (export "or-with-complex-expressions" (func 30))
  (export "or-evaluates-expressions-from-left-to-right" (func 31))
  (export "or-true-short-circuits-to-true" (func 32))
  (start 33)
