(module
  ...
  (func (;28;)
    ...
    drop)
  (table (;0;) 22 funcref)
  (export "if-true" (func 11))
  (export "if-true-expression" (func 12))
  (export "if-true-does-not-evaluate-alternative" (func 13))
  (export "if-true-consequent-only" (func 14))
  (export "if-false" (func 15))
  (export "if-false-expression" (func 16))
  (export "if-false-does-not-evaluate-consequent" (func 17))
  (export "if-false-consequent-only" (func 18))
  (export "if-lambda-condition" (func 20))
  (export "if-lambda-consequent" (func 23))
  (export "if-lambda-alternative" (func 27))
  (start 28)
