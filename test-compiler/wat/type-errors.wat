(module
  ...
  (export "procedure-plus-two" (func 28))
  (export "apply-to" (func 29))
  (export "unspecified-plus-two" (func 30))
  (export "unspecified-as-operator" (func 32))
  (export "symbol-plus-two" (func 33))
  (export "symbol-as-operator" (func 34))
  (export "string-plus-two" (func 35))
