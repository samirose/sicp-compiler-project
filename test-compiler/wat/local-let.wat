(module
  ...
  (func (;34;)
    ...
    drop)
  (table (;0;) 26 funcref)
  (export "constant-let" (func 17))
  (export "expression-let" (func 18))
  (export "multi-variable-let" (func 19))
  (export "nested-let" (func 20))
  (export "nested-let-referring-outer-let" (func 21))
  (export "let-shadowing-let" (func 22))
  (export "let-in-lambda" (func 24))
  (export "let-value-referring-lambda-arg" (func 26))
  (export "let-value-shadowing-lambda-arg" (func 28))
  (export "lambda-as-let-value" (func 30))
  (export "mutate-locals" (func 31))
  (export "get-global-with-let-value" (func 32))
  (export "get-global-assigned-with-let-value" (func 33))
  (start 34)
