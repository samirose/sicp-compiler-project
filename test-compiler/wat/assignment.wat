(module
  ...
  (func (;21;)
    ...
    drop)
  (table (;0;) 13 funcref)
  (export "set!-local-lambda" (func 14))
  (export "set!-local-let" (func 15))
  (export "set!-global" (func 16))
  (export "get-global" (func 17))
  (export "increment-global!" (func 18))
  (export "get-lambda-computed-global" (func 19))
  (start 21)
