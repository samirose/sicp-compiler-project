(module
  ...
  (func (;21;)
    ...
    drop)
  (table (;0;) 13 funcref)
  (export "literal-symbol-is-symbol" (func 14))
  (export "literal-symbols-with-same-name-are-eq" (func 15))
  (export "literal-symbols-with-different-name-are-not-eq" (func 16))
  (export "literal-symbols-as-values-are-symbols" (func 19))
  (export "symbol-may-contain-special-characters" (func 20))
  (start 21)
