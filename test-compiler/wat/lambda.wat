(module
  ...
  (func (;29;)
    ...
    drop)
  (table (;0;) 21 funcref)
  (export "lambda-application" (func 14))
  (export "lambda-argument" (func 18))
  (export "lambda-without-parameters" (func 20))
  (export "lambda-parameters-shadow-globals" (func 22))
  (export "inner-lambda-parameters-shadow-outer" (func 25))
  (export "lambda-procedure-result" (func 28))
  (start 29)
