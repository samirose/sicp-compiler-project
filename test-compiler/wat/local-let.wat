(module
  ...
  (func (;33;)
    ...
    drop)
  (table (;0;) 25 funcref)
  (export "constant-let" (func 16))
  (export "expression-let" (func 17))
  (export "multi-variable-let" (func 18))
  (export "nested-let" (func 19))
  (export "nested-let-referring-outer-let" (func 20))
  (export "let-shadowing-let" (func 21))
  (export "let-in-lambda" (func 23))
  (export "let-value-referring-lambda-arg" (func 25))
  (export "let-value-shadowing-lambda-arg" (func 27))
  (export "lambda-as-let-value" (func 29))
  (export "mutate-locals" (func 30))
  (export "get-global-with-let-value" (func 31))
  (export "get-global-assigned-with-let-value" (func 32))
  (start 33)
