(module
  ...
  (func (;30;)
    ...
    drop)
  (table (;0;) 22 funcref)
  (export "plus-identity" (func 15))
  (export "multiply-identity" (func 16))
  (export "plus-single" (func 17))
  (export "plus-single-expr" (func 18))
  (export "minus-single" (func 19))
  (export "minus-single-expr" (func 20))
  (export "multiply-single" (func 21))
  (export "plus-zero-to-positive" (func 22))
  (export "plus-positive-result" (func 23))
  (export "signed-plus-positive-result" (func 24))
  (export "signed-plus-zero-result" (func 25))
  (export "signed-plus-negative-result" (func 26))
  (export "plus-zero-to-negative" (func 27))
  (export "plus-multiple" (func 28))
  (export "complex" (func 29))
  (start 30)
