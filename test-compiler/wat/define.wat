(module
  ...
  (func (;23;)
    ...
    drop)
  (table (;0;) 15 funcref)
  (export "define-constants" (func 15))
  (export "define-combinations" (func 16))
  (export "define-lambda-combination" (func 18))
  (export "define-procedure" (func 20))
  (export "define-procedure-with-lambda" (func 22))
  (start 23)
