(module
  ...
  (export "if-true-expression" (func 11))
  (export "if-true-does-not-evaluate-alternative" (func 12))
  (export "if-true-consequent-only" (func 13))
  (export "if-false" (func 14))
  (export "if-false-expression" (func 15))
  (export "if-false-does-not-evaluate-consequent" (func 16))
  (export "if-false-consequent-only" (func 17))
  (export "if-lambda-condition" (func 19))
  (export "if-lambda-consequent" (func 22))
  (export "if-lambda-alternative" (func 26))
  (start 27)
