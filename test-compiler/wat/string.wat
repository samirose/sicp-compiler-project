(module
  ...
  (data (;0;) (i32.const 256) "\03\00\00\02foo")
  (data (;1;) (i32.const 264) "\06\00\00\02foobar")
  (data (;2;) (i32.const 276) "\0a\00\00\02got string")
  (data (;3;) (i32.const 292) "\0c\00\00\02bound string")
  (data (;4;) (i32.const 308) "\06\00\00\02foobar")
  (data (;5;) (i32.const 320) ")\00\00\02foo \09\0a\0d\5c'bar' \f0\9f\98\80 \f0\9f\a4\a6\f0\9f\8f\bc\e2\80\8d\e2\99\82\ef\b8\8f !@\7f\07")
  (data (;6;) (i32.const 368) "\00\00\00\02")
  (data (;7;) (i32.const 372) "\00\00\00\02")
  (data (;8;) (i32.const 376) "\01\00\00\02a")
  (data (;9;) (i32.const 384) "\01\00\00\02a")
  (data (;10;) (i32.const 392) "\01\00\00\02a")
  (data (;11;) (i32.const 400) "\01\00\00\02b")
  (data (;12;) (i32.const 408) " \00\00\02:foo#\f0\9f\98\80\f0\9f\a4\a6\f0\9f\8f\bc\e2\80\8d\e2\99\82\ef\b8\8fbar!\0d\0a")
  (data (;13;) (i32.const 444) " \00\00\02:foo#\f0\9f\98\80\f0\9f\a4\a6\f0\9f\8f\bc\e2\80\8d\e2\99\82\ef\b8\8fbar!\0d\0a")
  (data (;14;) (i32.const 480) "\08\00\00\02:foobar#")
  (data (;15;) (i32.const 492) "\08\00\00\02:foobaz#")
  (data (;16;) (i32.const 504) "\08\00\00\02:foobar#")
  (data (;17;) (i32.const 516) "\09\00\00\02:foobazz#")
  (data (;18;) (i32.const 532) "\04\00\00\02symb")
  (data (;19;) (i32.const 540) "\04\00\00\01symb")
