(module
  ...
  (func (;32;)
    ...
    drop)
  (table (;0;) 18 funcref)
  (export "all-with-single-argument-are-true" (func 24))
  (export "binary-equal" (func 25))
  (export "binary-greater-than" (func 26))
  (export "binary-less-than" (func 27))
  (export "binary-greater-or-equal-than" (func 28))
  (export "binary-less-or-equal-than" (func 29))
  (export "more-than-two-params-true" (func 30))
  (export "more-than-two-params-false" (func 31))
  (start 32)
  (elem (;0;) (i32.const 0) func 9 10 11 12 13 14 15 16 19 23 24 25 26 27 28 29 30 31)
