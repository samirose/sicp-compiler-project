(module
  ...
  (func (;22;)
    ...
    drop)
  (table (;0;) 14 funcref)
  (export "all-with-single-argument-are-true" (func 14))
  (export "binary-equal" (func 15))
  (export "binary-greater-than" (func 16))
  (export "binary-less-than" (func 17))
  (export "binary-greater-or-equal-than" (func 18))
  (export "binary-less-or-equal-than" (func 19))
  (export "more-than-two-params-true" (func 20))
  (export "more-than-two-params-false" (func 21))
  (start 22)
