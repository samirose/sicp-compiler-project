(module
  ...
  (func (;34;)
    ...
    drop)
  (table (;0;) 26 funcref)
  (export "override-quote-let" (func 17))
  (export "override-quote-arg" (func 20))
  (export "override-define-let" (func 22))
  (export "override-define-arg" (func 25))
  (export "override-lambda-let" (func 27))
  (export "override-lambda-arg" (func 30))
  (export "override-special-symbols-let*" (func 33))
  (start 34)
